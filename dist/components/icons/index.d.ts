...
export type IconName = "announcement" | "church" | "class" | "crown" | "event" | "gift" | "home" | "lock-closed" | "lock-open" | "ministry" | "podcast" | "series" | "sermon" | "subscription";
export declare function Icon({ name, ...props }: IconProps & {
    name: IconName;
}): import("react/jsx-runtime").JSX.Element;
export { AnnouncementIcon, ChurchIcon, ClassIcon, CrownIcon, EventIcon, GiftIcon, HomeIcon, LockClosedIcon, LockOpenIcon, MinistryIcon, PodcastIcon, SeriesIcon, SermonIcon, SubscriptionIcon, };
